...
public class LoginRequest extends StringRequest {
    ...
    private static final String LOGIN_REQUEST_URL = " http://test9.525j.com.cn/common/passportapi/v1.0/passport.employee.login";
    private String params;

    public LoginRequest(LoginPostBody postBody, Response.Listener<String> listener, Response.ErrorListener errorListener) {
        super(Method.POST, LOGIN_REQUEST_URL, listener, errorListener);
        params = new Gson().toJson(postBody);
        Log.d("HTTP REQUEST URL", LOGIN_REQUEST_URL);
